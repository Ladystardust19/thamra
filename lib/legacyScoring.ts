/* ============================================================================
 * ⚠️ LEGACY (v1) — retained ONLY to power the temporary LegacyResultScreen and
 * to keep historical v1 quiz_leads rows readable in the admin during the v2
 * migration. The live quiz flow now uses lib/scoring.ts (v2). Remove this file
 * together with LegacyResultScreen.tsx when the new result page ships.
 * ----------------------------------------------------------------------------
