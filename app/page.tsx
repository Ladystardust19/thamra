...
const advisors = [
  {
    ...
    quote:
      "Thamra-ს ფორმულაზე მუშაობისას ჩვენმა გუნდმა ყველა თანამედროვე სამეცნიერო კვლევებს მოუყარა თავი. ჩვენ გვინდოდა შეგვექმნა ფორმულა, რომელიც გააერთიანებდა ყველა იმ ინგრედიენტს, რომელიც თმის ძირებს ეხმარება გამაგრებაში, ზრდაში და გაახალგაზრდავებაში.",
