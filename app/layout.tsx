...
export default function RootLayout({
  ...
  // Only load the Meta Pixel on the real production site. Preview deploys and
  // local dev must NOT fire events — otherwise our own clicks pollute the data
  // and Meta flags the (health-related) preview domains.
