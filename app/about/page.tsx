    ...
    <main className="bg-cream min-h-screen">
      <div className="mx-auto w-full max-w-3xl px-6 sm:px-12 pt-28 pb-24 md:pt-32 md:pb-28">
        ...
        <div className="mt-8 space-y-5 font-body text-[17px] sm:text-[19px] font-light leading-[1.85] text-read">
          <p>
            THAMRA არის საკვები დანამატი, რომელიც შევქმენით მენოპაუზის ბიოლოგიური ცვლილებების გათვალისწინებით — ქალებისთვის, რომლებიც ეძებენ გააზრებულ და თანმიმდევრულ გზას თმის სიმკვრივეზე, მოცულობასა და ხარისხზე ზრუნვისთვის.
          </p>
          <p>
